...
def value_of_card(card):
    ...
    if card in card_values_dict:
        card_value = card_values_dict.get(card)
        return card_value
...
def is_blackjack(card_one, card_two):
    ...
    return True if (card_one_value + card_two_value + ace_in_hand) == 21 else False
...
def can_double_down(card_one, card_two):
    ...
    return True if ((card_one_value + card_two_value) in double_down_scores) else False